...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a1krzzlyx2vrk2-ats.iot.ap-northeast-1.amazonaws.com --ca_file root-CA.crt --cert TestThing.cert.pem --key TestThing.private.key --client_id basicPubSub --topic sdk/test/Python --count 0